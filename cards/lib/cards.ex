defmodule Cards do
  ...
  @doc """
    Return a list of strings representing a deck of random cards
  """
  ...
  @doc """
    Load a deck from a binary file
  """

  def load(filename) do
    case File.read(filename) do
      {:ok, binary} -> :erlang.binary_to_term(binary)
      {:ok, _reason} -> "That file doesn't exists"
    end
  end
end
